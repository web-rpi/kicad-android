...
mkdir -p ngspice && curl -L -o - 'https://sourceforge.net/projects/ngspice/files/ng-spice-rework/old-releases/42/ngspice-42.tar.gz' | tar -xz --strip-components=1 -C ngspice
